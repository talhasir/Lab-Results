                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>(g)</td>
                                <td><input type="text" name="H9" id=""></td>
                                <td><input type="text" name="J9" id=""></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="J23" id=""></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="J24" id=""></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="J25" id=""></td>
