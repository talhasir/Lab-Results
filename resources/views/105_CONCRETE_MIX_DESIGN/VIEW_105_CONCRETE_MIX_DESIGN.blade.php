                ...
                <div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="number" value="{{ $data->I15 }}" disabled name="I15"
                                        id=""></td>
                                <td>Strength "PSI"</td>
                                <td><input type="number" value="{{ $data->L15 }}" disabled name="L15"
                                        id=""></td>
                                <td>Target</td>
                                <td id="result"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3" id="result"></td>
                                <td rowspan="2" colspan="3"><input type="number" value="{{ $data->I20 }}"
                                        disabled name="I20" id=""
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Load (KN)</td>
                                <td><input type="number" value="{{ $data->E36 }}" disabled name="E36"
                                        id=""></td>
                                <td><input type="number" value="{{ $data->H36 }}" disabled name="H36"
                                        id=""></td>
                                <td><input type="number" value="{{ $data->J36 }}" disabled name="J36"
                                        id=""></td>
                                <td><input type="number" value="{{ $data->K36 }}" disabled name="K36"
                                        id=""></td>
                                <td><input type="number" value="{{ $data->L36 }}" disabled name="L36"
                                        id=""></td>
                                <td><input type="number" value="{{ $data->N36 }}" disabled name="N36"
                                        id=""></td>
                            </tr>
                            <tr>
                                <td>Comp. strength (PSI)</td>
                                <td><input type="number" value="{{ $data->E37 }}" disabled name="E37"
                                        id=""></td>
                                <td><input type="number" value="{{ $data->H37 }}" disabled name="H37"
                                        id=""></td>
                                <td><input type="number" value="{{ $data->J37 }}" disabled name="J37"
                                        id=""></td>
                                <td><input type="number" value="{{ $data->K37 }}" disabled name="K37"
                                        id=""></td>
                                <td><input type="number" value="{{ $data->L37 }}" disabled name="L37"
                                        id=""></td>
                                <td><input type="number" value="{{ $data->N37 }}" disabled name="N37"
                                        id=""></td>
                            </tr>
                            <tr>
