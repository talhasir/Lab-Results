                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-4" id="body">
                                ...
                                <input value="{{ $data->C9 }}" disabled name="C9" type="text"
                                    placeholder="Ring Factor:" class="p-3 rounded-sm" />
                                <span class="p-3">No. of Blows</span>
                                <input value="{{ $data->I9 }}" disabled name="I9" type="text"
                                    placeholder="Ring Factor:" class="p-3 rounded-sm" />
                            </div>
                            <div class="grid grid-cols-4" id="body">
                    ...
                    <div class="grid grid-cols-1">
                        <div>
                            ...
                            <div class="grid grid-cols-6" id="body">
                                <span class="p-3">Can No.</span>
                                <input value="{{ $data->C19 }}" disabled name="C19" type="text"
                                    placeholder="" class="p-3 rounded-sm" />
                                <span class="p-3">Wt. of Container (gm)</span>
                                <input value="{{ $data->I19 }}" disabled name="I19" type="text"
                                    placeholder="" class="p-3 rounded-sm" />
                                <span class="p-3">Can + Wet Soil (gm)</span>
                    ...
                    <div class="grid grid-cols-1">
                        <div>
                            ...
                            <div class="grid grid-cols-12" id="body">
                                ...
                                <input value="{{ $data->K19 }}" disabled name="K19" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->M19 }}" disabled name="M19" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->N19 }}" disabled name="N19" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->P19 }}" disabled name="P19" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->Q19 }}" disabled name="Q19" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->S19 }}" disabled name="S19" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->U19 }}" disabled name="U19" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->W19 }}" disabled name="W19" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->Y19 }}" disabled name="Y19" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->AA19 }}" disabled name="AA19" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                            ...
                            <div class="grid grid-cols-12" id="body">
                                ...
                                <input value="{{ $data->K20 }}" disabled name="K20" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->M20 }}" disabled name="M20" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->K20 }}" disabled name="N20" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->P20 }}" disabled name="P20" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->Q20 }}" disabled name="Q20" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->S20 }}" disabled name="S20" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->U20 }}" disabled name="U20" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->U20 }}" disabled name="W20" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->Y20 }}" disabled name="Y20" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->AA20 }}" disabled name="AA20" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->AB20 }}" disabled name="AB20" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                            </div>
                            <div class="grid grid-cols-12" id="body">
                            ...
                            <div class="grid grid-cols-12" id="body">
                                ...
                                <input value="{{ $data->K19 }}" disabled name="K19" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm col-span-11" />
                            </div>
                            <div class="grid grid-cols-12" id="body">
                            ...
                            <div class="grid grid-cols-12" id="body">
                                ...
                                <input value="{{ $data->K25 }}" disabled name="K25" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->M25 }}" disabled name="M25" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->N25 }}" disabled name="N25" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->P25 }}" disabled name="P25" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->Q25 }}" disabled name="Q25" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->S25 }}" disabled name="S25" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->U25 }}" disabled name="U25" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->W25 }}" disabled name="W25" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->Y25 }}" disabled name="Y25" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->AA25 }}" disabled name="AA25" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                                <input value="{{ $data->AB25 }}" disabled name="AB25" type="text"
                                    placeholder="" class="py-1 px-3 rounded-sm" />
                            </div>
                        </div>
                    </div>
